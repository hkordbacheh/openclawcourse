# Lesson 2: Installation & First Run (~25 min)
...
See: [Onboarding Wizard](https://docs.openclaw.ai/start/wizard)
...
See: [Pairing](https://docs.openclaw.ai/start/pairing)
...
See: [Control UI](https://docs.openclaw.ai/web/control-ui)
...
- [ ] After first reply, briefly point to "where that came from": Gateway → Pi → tools (tease Lesson 3).
