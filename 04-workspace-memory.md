# Lesson 4: Workspace & Memory (~25 min)
...
See: [Workspace file map](https://docs.openclaw.ai/concepts/agent-workspace#workspace-file-map-what-each-file-means)
...
See: [Memory](https://docs.openclaw.ai/concepts/memory)
...
See: [Git backup](https://docs.openclaw.ai/concepts/agent-workspace#git-backup-recommended-private)
...
- [ ] Clarify: workspace is default cwd for file tools but **not** a hard sandbox; sandbox is separate (Lesson 6).
